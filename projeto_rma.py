...
def collision(img,x1,y1,x2,y2):
    ...
    try:
        ...
        print("X1 and X2 are the same, execute the code again.")
        # print("X1: ",x1)
        # print("X2: ",x2)
        # print("Y1: ",y1)
        # print("Y2: ",y2)
...
def RRT(img, img2, start, end, stepSize):
    ...
    print("RRT trying to find a path ...")
...
def img_prepossessing(img, start, end):
	...
	gazebo_map = rot_map[81:640, 147:710] # second crop
	...
	# show results
	# cv2.imwrite("img_pros_4.jpg",gazebo_map)
